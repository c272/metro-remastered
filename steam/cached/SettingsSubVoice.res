"steam/cached/SettingsSubVoice.res"
{
	...
	layout
	{
		...
		//When Active
		place { region=box control="WhenActiveLabel,TransmitMethodRadioButton1,TransmitMethodRadioButton2,PushToTalkKeyLabel,TransmitMethodRadioButton3,PushToTalkKeyEntry,MicrophoneLabel,MicrophoneVolume,SpeakerLabel,SpeakerVolume,MicMeter" y=161 dir=down spacing=6 }
